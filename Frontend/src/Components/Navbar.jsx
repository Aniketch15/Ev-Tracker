...
export default function Navbar() {
    ...
    const navItems=(<>
        ...
        <li><a href="/">Home</a></li>
        <li><a href="/course">Charging Station</a></li>
        <li><a>Going Electric</a></li>
        <li><a>Contact</a></li>
        <li><a>About</a></li>
  ...
  return (
   ...
   <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 ${
    sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duartion-300 transition-all ease-in-out":""
   }`}>
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2xl font-bold cursor-pointer">EvTracker</a>
  </div>
  ...
  <label className="px-3 py-2 border roundend-md flex items-center gap-2">
  <input type="text" className="grow outline-none dark:text-white" placeholder="Search" />
